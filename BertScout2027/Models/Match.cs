...
public class Match : BaseModel
{
    ...
    public static Match FromReader(SqliteDataReader reader)
    {
        ...
        var index = BaseFieldCount;
        match.MatchNumber = reader.GetInt32(index++);
        match.TeamNumber = reader.GetInt32(index++);
        match.ScoutName = reader.GetString(index++);
        //match.AutoNumberOfCycles = reader.GetInt32(index++);
        //match.AutoShootingSpeed = reader.GetInt32(index++);
        //match.AutoBallsPerCycle = reader.GetInt32(index++);
        //match.AutoAccuracy = reader.GetInt32(index++);
        //match.AutoRobotSpeed = reader.GetInt32(index++);
        //match.AutoFloorPickup = reader.GetInt32(index++) == 1;
        //match.AutoOutpostPickup = reader.GetInt32(index++) == 1;
        //match.AutoRoute = reader.GetInt32(index++);
        //match.AutoClimbingLevel = reader.GetInt32(index++);
        //match.TeleNumberOfCycles = reader.GetInt32(index++);
        //match.TeleShootingSpeed = reader.GetInt32(index++);
        //match.TeleBallsPerCycle = reader.GetInt32(index++);
        //match.TeleAccuracy = reader.GetInt32(index++);
        //match.TeleRobotSpeed = reader.GetInt32(index++);
        //match.TeleFloorPickup = reader.GetInt32(index++) == 1;
        //match.TeleOutpostPickup = reader.GetInt32(index++) == 1;
        //match.TeleRoute = reader.GetInt32(index++);
        //match.TeleClimbingLevel = reader.GetInt32(index++);
        match.Score = reader.GetInt32(index++);
        match.DefenseScore = reader.GetInt32(index++);
        match.Comments = reader.GetString(index++);
        return match;
    }
}
